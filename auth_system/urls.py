...
from .views import HomePage, Register, Login, Logout, profile, update_profile_picture, display_favorites, remove_favorite, clear_favorites, save_to_favorites, remove_saved_favorite
...
urlpatterns = [
    ...
    path('save-to-favorites/', save_to_favorites, name='save_to_favorites'),
    path('remove-saved-favorite/', remove_saved_favorite, name='remove_saved_favorite'),
